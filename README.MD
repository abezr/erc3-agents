...
- **improved-agent-erc3 v2.1** ⭐ **[RECOMMENDED]** - Enhanced SGR agent achieving 100% score on [ERC3-DEV benchmark](https://erc.timetoact-group.at/benchmarks/erc3-dev). Features:
  - 🆕 **Multi-LLM Support** - Works with Google Gemini (free!) OR OpenAI (v2.1)
  ...
  - See [MULTI_LLM_GUIDE.md](improved-agent-erc3/MULTI_LLM_GUIDE.md), [SUMMARY.md](SUMMARY.md), and [CHANGELOG.md](improved-agent-erc3/CHANGELOG.md) for details
